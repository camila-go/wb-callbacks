...
const startWithLetterA = array => array.filter(word => word.charAt(0).toLowerCase() === 'a');
...
const productOfArray = numbers => numbers.reduce((accumulator, currentValue) => accumulator * currentValue, 1);
